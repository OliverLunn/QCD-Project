...
ax.plot(deltas, photon(deltas, -0.5, 0), ".b", label="$K^{\'}/\kappa=0$")
ax.plot(deltas, photon(deltas, -0.5, -0.5), ".g", label="$K^{\'}/\kappa=-0.5$")
ax.plot(deltas, photon(deltas, -0.5,-1), ".c", label='$K^{\'}/\kappa=-1$')
ax.plot(deltas, photon(deltas, -0.5,-2), ".r", label='$K^{\'}/\kappa=-2$')
ax.set_xlabel('$\Delta_p/\kappa$',fontsize="28")
ax.set_ylabel('$<a^{+}a>$',fontsize="28")
